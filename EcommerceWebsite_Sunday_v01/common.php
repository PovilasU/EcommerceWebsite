...
function outputHeader($title){
    ...
    echo '<script src="prettydate.js"></script>';
    echo '<script src="hello.js"></script>';
    echo '<script src="bye.js"></script>';
...
function outputTopHeader(){
    ...
    echo '</a>';
    //echo '<p><a href="javascript:;" class="simpleCart_empty">Empty Cart</a></p>'; //JM doesn't make sense to put this button here, also it doesn't do anything right now.
    echo '</div>';
    echo '<div style="float: right" class="cart box_1">';
...
/* Ouputs the banner and the navigation bar
    The selected class is applied to the page that matches the page name variable */ //JM how does that work
...
//    echo '<li><a href="purchase-history.php">Purchase history</a></li>';
  //  echo '<li><a href="login.php">Login</a></li>';
    echo '<li><a href="logout.php">Logout</a></li>'; //JM add login button when user is not logged in?
    //echo '<li><a href="about.php">About</a></li>'; //JM information about us will be in the report

    echo '<li style="margin-top: 10px " ><input type="text"  placeholder="Search" id="userInput" /></li>';
    echo '<li style="margin-top: 100px "><div id="underInput" > </div></li>';
...
function outputCart(){
    if(isset($_GET['_id'])){
        ...
        $index = -1;
        $cart = unserialize(serialize($_SESSION['cart'])); //JM why unserialise serialise
...
//Pay button
    if(isset($_POST['bttPay'])) {
        ...
        $collection = $db->people; //JM think my database has a different name, change database.
        ...
        // test insert to database buy history
...
function outputFooter(){
    ...
    echo '<div class="container">';
    echo '<div class="container">';
    echo '<p class="navbar-text pull-left">Site Built By Povilas Urbonas and Jenny Messer 2017</p>';
    echo '</div><!--End of div class="container"-->';
    echo '</div><!--End of div class="navbar" , End of Footer-->';
    echo '<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>';
    echo '<script src="js/bootstrap.min.js"></script>';
    echo '   <script>    document.getElementById("prettyDate").innerHTML = prettyDate(Date(), Date());    </script> ';
    echo '<script>    document.getElementById("Customer").innerHTML = CurrentUser ;</script> ';
    echo '<script>    document.getElementById("login").innerHTML = login ;</script> ';
    echo '<script>    document.getElementById("hello").innerHTML = hello ;</script> ';
    echo ' <script>    document.getElementById("bye").innerHTML = bye ;</script>';
